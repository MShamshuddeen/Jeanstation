<%-- 
    Document   : Jeans
    Created on : Mar 7, 2016, 5:09:30 PM
    Author     : Shamshuddeen
--%>
...
<html>
  ...
  <div style="overflow:scroll" class="modal fade" id="account" role="dialog">
    ...
    <div id="home" class="tab-pane fade in active">
      <h3>Account</h3>
       <%
                                  HttpSession ob5=request.getSession();
                                  
                                  if(ob5.getAttribute("username")==null){
                                  ...
                                  String usr=(ob5.getAttribute("username").toString());
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            ...
            <div id="head">
                ...
                <div id="searchbox_div">
                    ...
                    <input type="text" name="keyword" id="searchbox"></input>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="login.html"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
         ...
         Connection con=DriverManager.getConnection("jdbc:odbc:jeanstation","sa","domnic");
         Statement st=con.createStatement();
         ResultSet rs=st.executeQuery("select*from product where pname like '%"+keyword+"%' ");
          ...
          if(rs.next()){
	       ...
	       out.println("</div>");
              if(i==4)
              {
                ...
                out.println("<h3>Sorry, We've got no results for <span style='color:#2DBFF5;'>"+keyword+"</span></h3>");
                out.println("<h5>We suggest that you:</h5>");
                out.println("<h5>Check your Spelling</h5>");
          }
           out.println("</div>");  
              }
              catch(Exception e){
