...
<%-- 
    Document   : index
    Created on : Feb 22, 2016, 7:52:31 PM
    Author     : Shamshuddeen
--%>
...
<html>
    <head>
        ...
        <title>JeanStation : Home</title>
        <link rel="StyleSheet" href="style/StyleSheet.css"/>
        <link rel="stylesheet" href="style/my-slider.css"/>
    ...
    <div id="home" class="tab-pane fade in active">
      <h3>Account</h3>
       <%
                                  ...
                                  if(ob.getAttribute("username")==null){
                                  ...
                                  String usr=(ob.getAttribute("username").toString());
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            ...
            <div id="head">
                ...
                <div id="logo_div">
                    <img src="images/logo.png" id="logo" onclick="location.href='index.jsp'" />
                </div>
                ...
                <div id="head_all_btn">
                    ...
                    <div class="head_all_btn1">
                        <button class="hbtn2" type="submit" data-toggle="modal" data-target="#account"  style="border: 1px none #FFFFFF;background-color:#FFFFFF;width:78px;height:26px;">
...
<li>
      <img src="images/slides/slider4.jpg">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="login.html"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
		...
		<div class="catname">
		<h3 style="margin-left:20px;margin-top:3px;float:left;"><b>Jeans</b</h3>
		</div>
         ...
         Connection con=DriverManager.getConnection("jdbc:odbc:jeanstation","sa","domnic");
         Statement st=con.createStatement();
         ResultSet rs=st.executeQuery("select top 4*from  product where pcat='Jeans' order by pid desc ");
         while(rs.next()){
             prodid=rs.getInt(1);
            ...
            imagee=this.getServletContext().getInitParameter("imglocation")+"/jeans/"+rs.getString("img");
				...
				out.println("<div class='proddet'>");
                        out.println("<div class='prodimg'>");
                           out.println("<img src='"+imagee+"' style='width:220px;height:180px;float:left;'/>");
        ...
        <div class="new_arrival">
        <div class="catname">
		<h3 style="margin-left:20px;margin-top:3px;float:left;"><b>T-Shirts</b</h3>
		</div>
            <%
                  try{
                                            String imagee;
         ...
         Connection con=DriverManager.getConnection("jdbc:odbc:jeanstation","sa","domnic");
         Statement st=con.createStatement();
         ResultSet rs=st.executeQuery("select top 4*from product where pcat='Tshirts' order by pid desc");
         while(rs.next()){
             prodid=rs.getInt(1);
             prodname=rs.getString(2);
             price=rs.getInt(5);
        ...
        <div class="new_arrival">
        <div class="catname">
		<h3 style="margin-left:20px;margin-top:3px;float:left;"><b>Shirts</b</h3>
		</div>
             <%
                  try{
                                            String imagee;
         ...
         Connection con=DriverManager.getConnection("jdbc:odbc:jeanstation","sa","domnic");
         Statement st=con.createStatement();
         ResultSet rs=st.executeQuery("select top 4*from product where pcat='Shirts' order by pid desc");
         while(rs.next()){
             prodid=rs.getInt(1);
             prodname=rs.getString(2);
             price=rs.getInt(5);
        ...
        <div class="new_arrival">
        <div class="catname">
		<h3 style="margin-left:20px;margin-top:3px;float:left;"><b>Trousers</b</h3>
		</div>
           <%
                  try{
                                            String imagee;
         ...
         Connection con=DriverManager.getConnection("jdbc:odbc:jeanstation","sa","domnic");
         Statement st=con.createStatement();
         ResultSet rs=st.executeQuery("select top 4*from product where pcat='Trousers' order by pid desc");
         while(rs.next()){
             prodid=rs.getInt(1);
             prodname=rs.getString(2);
             price=rs.getInt(5);
