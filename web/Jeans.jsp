...
<html>
 ...
 <div style="overflow:scroll" class="modal fade" id="account" role="dialog">
    ...
    <div id="home" class="tab-pane fade in active">
      <h3>Account</h3>
       <%
                                  HttpSession ob2=request.getSession();
                                  
                                  if(ob2.getAttribute("username")==null){
                                  ...
                                  String usr=(ob2.getAttribute("username").toString());
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="Jeans.jsp">Jeans</a></li>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="login.html"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
         ...
         Connection con=DriverManager.getConnection("jdbc:odbc:jeanstation","sa","domnic");
         Statement st=con.createStatement();
         ResultSet rs=st.executeQuery("select*from product where pcat='Jeans'");
