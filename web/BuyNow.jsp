<%-- 
    Document   : BuyNow
    Created on : Mar 3, 2016, 5:04:20 PM
    Author     : Shamshuddeen
--%>
...
<html>
    <head>
        ...
        <title>JeanStation : BuyNow</title>
 ...
 <div style="overflow:scroll" class="modal fade" id="account" role="dialog">
    ...
    <div id="home" class="tab-pane fade in active">
      <h3>Account</h3>
       <%
                                  HttpSession ob1=request.getSession();
                                  
                                  if(ob1.getAttribute("username")==null){
                                  ...
                                  String usr=(ob1.getAttribute("username").toString());
    ...
    <div id="changepass" class="tab-pane fade">
       ...
       <input type='button' onclick='location.href="login.html"' class='btn btn-info' value='Login'/> 
        ...
        <form role="form" action="PasswordChange?username=<%=usr%>" method="post">
		...
		<div id="sectionform">
               ...
               HttpSession ob=request.getSession();
                                  ...
                                  if(ob.getAttribute("username")==null){
                                      %>    
                                      <br/>
                 <h4 style='color:#2DBFF5;'>Please Login First</h4>
		 <form role="form" action="BuyNowLogin?pid=<%=pid%>&quantity=<%=quantity%>&size=<%=size%>" method="post">
    <div class="form-group">
    ...
    <input type="submit" class="btn btn-info" value="Login"/>
        ...
        <%
               ...
               try{
                ...
                <form role="form" action="Revieworder.jsp" method="get">
		<h4 style='color:#2DBFF5;'>Enter Shipping Address</h4>
                <input type="hidden" class="form-control" name="pid"  value="<%=pid%>" required>
                <input type="hidden" class="form-control" name="quantity"  value="<%=quantity%>" required>
                <input type="hidden" class="form-control" name="size"  value="<%=size%>" required>
		<div class="form-group">
      <label for="usr">Full Name:</label>
      <input type="text" class="form-control" name="username" id="usr" value="<%=name%>" required>
    </div>
	<div class="form-group">
      <label for="usr">Shipping Address:</label>
      <textarea  class="form-control" rows="5" name="saddress" id="comment" required></textarea>
    </div>
	<div class="form-group">
    ...
    <button type="submit" class="btn btn-info" >Continue
